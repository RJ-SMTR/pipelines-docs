# POLÍTICA DE GOVERNANÇA DE DADOS DA DTDI

**Diretoria Técnica de Dados e Inovação**  
...
A Secretaria Municipal de Transportes (SMTR) reconhece os dados como ativos estratégicos essenciais para o cumprimento de sua missão e deveres regulatórios. Assim, alinhada ao Decreto Rio nº 54.984/2024 e ao Art. 5º da LGPD (Lei nº 13.709/2018), a SMTR assume a gestão estratégica e a posição de Controladora, enquanto a TR/SUBTT atua como sua unidade administrativa competente para deliberar sobre os tratamentos específicos. Complementarmente, a IPLANRIO/PRE/VPIA/DTDI figura como Operadora, executando o tratamento segundo as diretrizes estipuladas e respondendo pela Curadoria Técnica de Dados (Technical Data Steward) e pela Custódia dos Dados. A partir dessa atribuição legal e da necessidade de organizar tais responsabilidades sem duplicidades, a DTDI elaborou a presente Política de Governança de Dados como um meio dinâmico para documentar as iniciativas em curso e guiar a evolução consistente do ecossistema de dados da SMTR.dados.

### 1.1 Sobre a Gestão de Dados e suas Áreas de Conhecimento

A Gestão de Dados é um conjunto de áreas de conhecimento que aplicam práticas especializadas para tratar os dados em todo o seu ciclo de vida. A DTDI **deve** reconhecer e atuar conforme as seguintes áreas de conhecimento:
...
### 1.2 Sobre a Governança de Dados

Fundamentada no DAMA-DMBOK, que a conceitua como o exercício de autoridade, controle e tomada de decisão compartilhada sobre os ativos de dados, a Governança **deve** atuar como o pilar central da Gestão de Dados. Ela **deve** estruturar diretrizes, regulamentos e rotinas pautadas na ética e em boas práticas corporativas, impulsionando a transformação cultural necessária para que as demais frentes operem em sintonia com os objetivos do negócio e promovam a criação contínua de valor. Complementarmente, a Governança **deve** acompanhar os indicadores de desempenho da gestão, prestando suporte transversal às equipes, aos custódios de dados e ao desenvolvimento dos colaboradores no fortalecimento de uma cultura data-driven.
...
**Objetivo 1 — Conformidade e Gestão Responsável:** Orientar os profissionais da DTDI a atuar em conformidade com a legislação aplicável (LGPD, Decreto Rio nº 54.984/2024, Decreto Rio nº 53.700/2023 e demais instrumentos regulatórios) e em alinhamento com altos padrões de gestão dos ativos de informação sob sua responsabilidade e custódia.

**Objetivo 2 — Bússola para Decisões Coordenadas:** Funcionar como instrumento de orientação para decisões e processos multidisciplinares que exigem esforço coordenado e interdependente entre as equipes de negócio, os times de tecnologia, os especialistas em dados e a liderança da DTDI, viabilizando o alcance de objetivos organizacionais em segurança e conformidade legal.

**Objetivo 3 — Atribuição de Responsabilidades:** Estabelecer de forma clara e inequívoca as responsabilidades de diferentes atores em diferentes etapas do ciclo de vida dos dados, evidenciando que a governança de dados é um esforço coletivo, multidisciplinar e contínuo.

**Objetivo 4 — Construção de Bases Sólidas de Gestão e Governança de Dados:** Estabelecer padrões técnicos e legais mínimos, responsáveis por conferir qualidade e confiabilidade aos processos e operações do ecossistema de gestão de dados e informação SMTR.

**Objetivo 5 — Desenvolvimento da Maturidade em Dados:** Pavimentar o caminho para execução facilitada dos processos de gestão e governança de dados através de método replicável, com linguagem acessível, processos instruídos para estimular o engajamento e a participação ativa das áreas de negócio. O objetivo é facilitar o fluxo do processo para que cada ator assuma, naturalmente, a respectiva responsabilidade atribuída pela regulação, considerando que a gestão e governança de dados é compartilhada ao longo do ciclo de vida.

---

## 3. ABRANGÊNCIA

Esta Política **aplica-se** a todas as iniciativas, processos, operações, sistemas e equipes da DTDI que envolvem a coleta, armazenamento, processamento, análise, proteção, compartilhamento ou descarte de dados. **Abrange** tanto o ambiente transacional, quanto o ambiente analítico. **Inclui** dados operacionais, dados de clientes, dados de terceiros sob custódia, dados públicos e dados internos da DTDI.

A Política **é mandatória** para todos os profissionais da DTDI e **vinculante** para fornecedores, parceiros e terceiros que acessem, processem ou armazenem dados sob responsabilidade da DTDI.
...
| Termo | Definição |
|-------|-----------|
| **Agentes de Tratamento** | Pessoas físicas ou jurídicas que realizam o tratamento de dados pessoais em nome do Controlador, conforme definido pela LGPD (Art. 5°, VIII). |
| **Alinhamento de Dados (TAD)** | Termo de Alinhamento de Dados — Instrumento formal que **deve** especificar requisitos, expectativas e responsabilidades para cada demanda de dados recebida pela DTDI. |
| **Analytics** | Área de conhecimento que **deve** aplicar técnicas de análise exploratória, descritiva, preditiva e prescritiva aos dados para gerar insights e subsidiar decisões. |
| **Arquitetura de Dados** | Área de conhecimento que **deve** definir estruturas, padrões, tecnologias e processos para armazenar, integrar, processar e disponibilizar dados de forma segura, escalável e eficiente. |
| **Armazenamento de Dados** | Área de conhecimento que **deve** garantir a persistência, disponibilidade, segurança e performance dos dados através de tecnologias e práticas adequadas. |
...
| **Conformidade** | Alinhamento com legislação, regulações, políticas e normas aplicáveis. A DTDI **deve** garantir conformidade em todas as operações de dados. |
| **Conformidade LGPD** | Aderência aos requisitos da Lei Geral de Proteção de Dados Pessoais (Lei 13.709/2018) e seus decretos regulamentadores. |
...
| **Dados Pessoais** | Informações que **devem** ser tratadas conforme LGPD, referentes a pessoa física identificada ou identificável. |
| **Dados Públicos** | Dados que **devem** ser disponibilizados conforme Lei de Acesso à Informação, sem restrições de segurança ou privacidade. |
| **Decreto Rio nº 53.700/2023** | Política de Segurança da Informação do Rio de Janeiro que **deve** ser observada em todas as operações de dados da DTDI. |
| **Decreto Rio nº 54.984/2024** | Política de Proteção de Dados Pessoais e Governança de Dados que **deve** fundamentar as operações de governança da DTDI. |
| **Decreto Rio nº 56.646/2025** | Decreto que **deve** estabelecer diretrizes de Governança de Dados e Interoperabilidade para órgãos municipais. |
| **Decreto Rio nº 56.647/2025** | Decreto que **deve** estabelecer diretrizes de Conformidade e Auditoria de Dados para órgãos municipais. |
| **Decreto Rio nº 56.649/2025** | Decreto que **deve** estabelecer diretrizes de Proteção de Dados Pessoais em Sistemas Municipais. |
...
| **ETL** | Extract, Transform, Load — Processo que **deve** extrair dados de fontes, transformá-los conforme regras e carregá-los em destino. |
| **EtLT** | Extract, Load, Transform — Variação do ETL que **deve** carregar dados primeiro e transformar posteriormente, apropriada para grandes volumes. |
| **Evidência Técnica** | Documentação, logs, metadados ou artefatos que **devem** comprovar a conformidade e qualidade das operações de dados. |
| **Finalidade** | Propósito específico para o qual dados **devem** ser tratados, conforme LGPD (Princípio da Finalidade). |
| **Gestão de Acesso** | Processo que **deve** controlar quem, quando e como acessa dados, conforme princípios de segurança e conformidade. |
| **Gestão de Credenciais** | Processo que **deve** gerenciar senhas, tokens e chaves de acesso de forma segura, com temporalidade e auditoria. |
| **Gestão de Dados** | Conjunto de disciplinas e práticas que **devem** ser aplicadas para tratar dados em todo o seu ciclo de vida. |
| **Gestão de Incidentes de Qualidade** | Processo que **deve** identificar, registrar, investigar e resolver problemas de qualidade de dados, eliminando causas raiz. |
...
| **IPLANRIO** | Instituto Pereira Passos — Entidade que, em conjunto com VPIA e DTDI, **deve** exercer a custódia técnica de dados. |
| **Indicadores** | Métricas quantitativas que **devem** medir o desempenho e a eficácia da governança de dados. |
| **Iniciativa de Governança** | Projeto, processo ou prática que **deve** ser implementado para melhorar a governança de dados. |
| **Integração de Dados** | Área de conhecimento que **deve** garantir a compatibilidade, interoperabilidade e fluxo seguro de dados entre sistemas. |
| **Interoperabilidade** | Capacidade que **deve** permitir que sistemas e dados funcionem conjuntamente de forma segura e eficiente. |
| **ISO/IEC 27001** | Norma internacional que **deve** fundamentar a gestão de segurança da informação e proteção de dados. |
